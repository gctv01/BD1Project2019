...
CREATE TABLE ORGANIGRAMA(
    ...
    id_superior NUMERIC(4),
    descripcion VARCHAR(30),

    PRIMARY KEY(id),
    FOREIGN KEY(id_superior) REFERENCES ORGANIGRAMA(id)
);
...
CREATE TABLE EMPLEO(
    ...
    id_empleado NUMERIC(4) NOT NULL,
    id_organigrama NUMERIC(4) NOT NULL,
    fecha_fin DATE,
...
CREATE TABLE TURNOS_HIST(
    ...
    id_empleo DATE NOT NULL,
    fecha_fin DATE,

    PRIMARY KEY(fecha_inicio,id_empleo),
    FOREIGN KEY(id_empleo) REFERENCES EMPLEO(fecha_inicio)
);
...
CREATE TABLE REUNION(
    ...
    id_supervisor NUMERIC(4) NOT NULL,

    PRIMARY KEY(id,id_supervisor),
    FOREIGN KEY(id_supervisor) REFERENCES EMPLEADO(expediente)
);

CREATE TABLE INASISTENCIA(
    id_empleo DATE NOT NULL,
    id_reunion NUMERIC(4) NOT NULL,

    PRIMARY KEY(id_empleo,id_reunion),
    FOREIGN KEY(id_empleo) REFERENCES EMPLEO(fecha_inicio),
